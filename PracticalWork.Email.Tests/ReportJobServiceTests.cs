...
public class ReportJobServiceTests
{
    ...
    public async Task GenerateWeeklyReport_QueriesStatisticForPreviousWeek()
    {
        ...
        var expectedEnd   = new DateTime(2025, 6, 15, 23, 59, 59);
    ...
    [Fact]
    public async Task GenerateWeeklyReport_UploadsToCorrectBucket()
    {
        // Arrange
        SetupDefaultMocks();
        ...
        _minioServiceMock
            .Setup(m => m.UploadFileAsync(
                ...
                It.IsAny<string>(),
                It.IsAny<string>()))
            .Callback<string, Stream, string, string>((_, _, _, bucket) => capturedBucket = bucket)
            .Returns(Task.CompletedTask);
        ...
        // Assert
        Assert.Equal("library-reports", capturedBucket);
    }
    ...
    public async Task GenerateWeeklyReport_ReportFileNameMatchesEndDate()
    {
        ...
        _minioServiceMock
            .Setup(m => m.UploadFileAsync(
                ...
                It.IsAny<string>(),
                It.IsAny<string>()))
            .Callback<string, Stream, string, string>((name, _, _, _) => capturedFileName = name)
            .Returns(Task.CompletedTask);
    ...
    [Fact]
    public async Task GenerateWeeklyReport_GetFileUrlUsesReportBucket()
    {
        // Arrange
        SetupDefaultMocks();
        ...
        _minioServiceMock
            .Setup(m => m.GetFileUrlAsync(
                ...
                It.IsAny<int>(),
                It.IsAny<string>()))
            .Callback<string, int, string>((_, _, bucket) => capturedBucket = bucket)
            .ReturnsAsync("https://minio.example.com/report.csv");
